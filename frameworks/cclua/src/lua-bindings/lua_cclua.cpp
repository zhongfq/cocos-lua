...
static int _cclua_runtime_capture$1(lua_State *L)
{
    ...
    float arg3 = 0;       /** height */
    float arg4 = 0;       /** scale */
    cocos2d::Texture2D::PixelFormat arg5 = (cocos2d::Texture2D::PixelFormat)0;       /** format */
    GLuint arg6 = 0;       /** depthStencilFormat */
...
static int _cclua_runtime_capture(lua_State *L)
{
    ...
    if (num_args == 6) {
        // if ((olua_is_object(L, 1, "cc.Node")) && (olua_is_number(L, 2)) && (olua_is_number(L, 3)) && (olua_is_number(L, 4)) && (olua_is_enum(L, 5)) && (olua_is_integer(L, 6))) {
            // static cocos2d::Sprite *capture(cocos2d::Node *node, float width, float height, @optional float scale, @optional cocos2d::Texture2D::PixelFormat format, @optional GLuint depthStencilFormat)
