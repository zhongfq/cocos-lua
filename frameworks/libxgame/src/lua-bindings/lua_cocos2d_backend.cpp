...
static int _cocos2d_backend_Buffer___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.Buffer");
...
static int _cocos2d_backend_Buffer_getSize(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.Buffer");
...
static int _cocos2d_backend_RenderPipeline___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.RenderPipeline");
...
static int _cocos2d_backend_DepthStencilState___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.DepthStencilState");
...
static int _cocos2d_backend_VertexLayout___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.VertexLayout");
...
static int _cocos2d_backend_VertexLayout_getAttributes(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.VertexLayout");
...
static int _cocos2d_backend_VertexLayout_new(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "ccb.VertexLayout");
    olua_postnew(L, ret);
...
static int _cocos2d_backend_CommandBuffer___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.CommandBuffer");
...
static int _cocos2d_backend_CommandBuffer_beginFrame(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.CommandBuffer");
...
static int _cocos2d_backend_CommandBuffer_setDepthStencilState(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.CommandBuffer");
    olua_check_obj(L, 2, &arg1, "ccb.DepthStencilState");
...
static int _cocos2d_backend_CommandBuffer_setIndexBuffer(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.CommandBuffer");
    olua_check_obj(L, 2, &arg1, "ccb.Buffer");
...
static int _cocos2d_backend_CommandBuffer_setRenderPipeline(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.CommandBuffer");
    olua_check_obj(L, 2, &arg1, "ccb.RenderPipeline");
...
static int _cocos2d_backend_Device___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.Device");
...
static int _cocos2d_backend_Device_createDepthStencilState(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.Device");
    ...
    int num_ret = olua_push_obj(L, ret, "ccb.DepthStencilState");
...
static int _cocos2d_backend_Device_getDeviceInfo(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "ccb.DeviceInfo");
...
static int _cocos2d_backend_Device_getInstance(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "ccb.Device");
...
static int _cocos2d_backend_Device_newCommandBuffer(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "ccb.CommandBuffer");
...
static int _cocos2d_backend_Device_newProgram(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "ccb.Program");
...
static int _cocos2d_backend_Device_newRenderPipeline(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "ccb.RenderPipeline");
...
static int _cocos2d_backend_Device_newTexture(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "ccb.TextureBackend");
...
static int _cocos2d_backend_DeviceInfo___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.DeviceInfo");
...
static int _cocos2d_backend_DeviceInfo_checkForFeatureSupported(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.DeviceInfo");
    olua_check_uint(L, 2, &arg1);
...
static int _cocos2d_backend_ShaderCache___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.ShaderCache");
...
static int _cocos2d_backend_ShaderCache_getInstance(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "ccb.ShaderCache");
...
static int _cocos2d_backend_ShaderCache_newFragmentShaderModule(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "ccb.ShaderModule");
...
static int _cocos2d_backend_ShaderCache_removeUnusedShader(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.ShaderCache");
...
static int _cocos2d_backend_ShaderModule___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.ShaderModule");
...
static int _cocos2d_backend_ShaderModule_getHashValue(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.ShaderModule");
...
static int _cocos2d_backend_ProgramCache___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.ProgramCache");
...
static int _cocos2d_backend_ProgramCache_addCustomProgram(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.ProgramCache");
    olua_check_std_string(L, 2, &arg1);
    olua_check_obj(L, 3, &arg2, "ccb.Program");
...
static int _cocos2d_backend_ProgramCache_getInstance(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "ccb.ProgramCache");
...
static int _cocos2d_backend_ProgramCache_removeProgram(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.ProgramCache");
    olua_check_obj(L, 2, &arg1, "ccb.Program");
...
static int _cocos2d_backend_ProgramState___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.ProgramState");
...
static int _cocos2d_backend_ProgramState_clone(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.ProgramState");
...
static int _cocos2d_backend_ProgramState_new(lua_State *L)
{
    ...
    olua_check_obj(L, 1, &arg1, "ccb.Program");
...
static int _cocos2d_backend_ProgramState_setTexture(lua_State *L)
{
    ...
    olua_check_uint(L, 3, &arg2);
    olua_check_obj(L, 4, &arg3, "ccb.TextureBackend");
...
static int _cocos2d_backend_ProgramState_setTextureArray(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.ProgramState");
    olua_check_cocos2d_backend_UniformLocation(L, 2, &arg1);
    olua_check_array<uint32_t>(L, 3, &arg2, [L](uint32_t *value) {
        lua_Unsigned obj;
        olua_check_uint(L, -1, &obj);
        *value = (uint32_t)obj;
    });
    olua_check_array<cocos2d::backend::TextureBackend *>(L, 4, &arg3, [L](cocos2d::backend::TextureBackend **value) {
...
static int _cocos2d_backend_Program___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.Program");
...
static int _cocos2d_backend_Program_getActiveAttributes(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.Program");
...
static int _cocos2d_backend_TextureBackend___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.TextureBackend");
...
static int _cocos2d_backend_TextureBackend_generateMipmaps(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.TextureBackend");
...
static int _cocos2d_backend_Texture2DBackend___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.Texture2DBackend");
...
static int _cocos2d_backend_TextureCubemapBackend___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "ccb.TextureCubemapBackend");
...
static int _cocos2d_backend_TextureCubemapBackend_updateFaceData(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "ccb.TextureCubemapBackend");
    olua_check_uint(L, 2, &arg1);
    olua_check_obj(L, 3, &arg2, "void *");
