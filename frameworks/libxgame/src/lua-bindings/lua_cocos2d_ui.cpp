...
static int luaopen_cocos2d_ui_PageViewIndicator(lua_State *L)
{
    ...
    oluacls_func(L, "clear", _cocos2d_ui_PageViewIndicator_clear);
    oluacls_func(L, "create", _cocos2d_ui_PageViewIndicator_create);
    oluacls_func(L, "getIndexNodesColor", _cocos2d_ui_PageViewIndicator_getIndexNodesColor);
    oluacls_func(L, "getIndexNodesOpacity", _cocos2d_ui_PageViewIndicator_getIndexNodesOpacity);
    oluacls_func(L, "getIndexNodesScale", _cocos2d_ui_PageViewIndicator_getIndexNodesScale);
    oluacls_func(L, "getSelectedIndexColor", _cocos2d_ui_PageViewIndicator_getSelectedIndexColor);
    oluacls_func(L, "getSelectedIndexOpacity", _cocos2d_ui_PageViewIndicator_getSelectedIndexOpacity);
    oluacls_func(L, "getSpaceBetweenIndexNodes", _cocos2d_ui_PageViewIndicator_getSpaceBetweenIndexNodes);
    oluacls_func(L, "indicate", _cocos2d_ui_PageViewIndicator_indicate);
    oluacls_func(L, "reset", _cocos2d_ui_PageViewIndicator_reset);
    oluacls_func(L, "setDirection", _cocos2d_ui_PageViewIndicator_setDirection);
    oluacls_func(L, "setIndexNodesColor", _cocos2d_ui_PageViewIndicator_setIndexNodesColor);
    oluacls_func(L, "setIndexNodesOpacity", _cocos2d_ui_PageViewIndicator_setIndexNodesOpacity);
    oluacls_func(L, "setIndexNodesScale", _cocos2d_ui_PageViewIndicator_setIndexNodesScale);
    oluacls_func(L, "setIndexNodesTexture", _cocos2d_ui_PageViewIndicator_setIndexNodesTexture);
    oluacls_func(L, "setSelectedIndexColor", _cocos2d_ui_PageViewIndicator_setSelectedIndexColor);
    oluacls_func(L, "setSelectedIndexOpacity", _cocos2d_ui_PageViewIndicator_setSelectedIndexOpacity);
    oluacls_func(L, "setSpaceBetweenIndexNodes", _cocos2d_ui_PageViewIndicator_setSpaceBetweenIndexNodes);
    oluacls_prop(L, "indexNodesColor", _cocos2d_ui_PageViewIndicator_getIndexNodesColor, _cocos2d_ui_PageViewIndicator_setIndexNodesColor);
    oluacls_prop(L, "indexNodesOpacity", _cocos2d_ui_PageViewIndicator_getIndexNodesOpacity, _cocos2d_ui_PageViewIndicator_setIndexNodesOpacity);
    oluacls_prop(L, "indexNodesScale", _cocos2d_ui_PageViewIndicator_getIndexNodesScale, _cocos2d_ui_PageViewIndicator_setIndexNodesScale);
    oluacls_prop(L, "selectedIndexColor", _cocos2d_ui_PageViewIndicator_getSelectedIndexColor, _cocos2d_ui_PageViewIndicator_setSelectedIndexColor);
    oluacls_prop(L, "selectedIndexOpacity", _cocos2d_ui_PageViewIndicator_getSelectedIndexOpacity, _cocos2d_ui_PageViewIndicator_setSelectedIndexOpacity);
    oluacls_prop(L, "spaceBetweenIndexNodes", _cocos2d_ui_PageViewIndicator_getSpaceBetweenIndexNodes, _cocos2d_ui_PageViewIndicator_setSpaceBetweenIndexNodes);
...
static int _cocos2d_ui_RichElementText_init(lua_State *L)
{
    ...
    manual_luacv_opt_cocos2d_Color3B(L, 10, &arg9, (cocos2d::Color3B)cocos2d::Color3B::WHITE);
    olua_opt_int(L, 11, &arg10, (lua_Integer)-1);
    manual_luacv_opt_cocos2d_Color3B(L, 12, &arg11, (cocos2d::Color3B)cocos2d::Color3B::BLACK);
    auto_luacv_opt_cocos2d_Size(L, 13, &arg12, (cocos2d::Size)cocos2d::Size(2.0, -2.0));
    olua_opt_int(L, 14, &arg13, (lua_Integer)0);
    manual_luacv_opt_cocos2d_Color3B(L, 15, &arg14, (cocos2d::Color3B)cocos2d::Color3B::WHITE);
...
static int _cocos2d_ui_EditBox_initWithSizeAndBackgroundSprite(lua_State *L)
{
    ...
    if (num_args == 2) {
        // if (auto_luacv_is_cocos2d_Size(L, 2) && olua_is_cppobj(L, 3, "ccui.Scale9Sprite")) {
            return _cocos2d_ui_EditBox_initWithSizeAndBackgroundSprite2(L);
        // }
    }

    if (num_args == 3) {
        // if (auto_luacv_is_cocos2d_Size(L, 2) && olua_is_std_string(L, 3) && (olua_is_uint(L, 4) || olua_isnil(L, 4))) {
            return _cocos2d_ui_EditBox_initWithSizeAndBackgroundSprite1(L);
        // }
    }

    if (num_args == 4) {
        // if (auto_luacv_is_cocos2d_Size(L, 2) && olua_is_cppobj(L, 3, "ccui.Scale9Sprite") && olua_is_cppobj(L, 4, "ccui.Scale9Sprite") && olua_is_cppobj(L, 5, "ccui.Scale9Sprite")) {
