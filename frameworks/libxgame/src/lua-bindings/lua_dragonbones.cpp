...
static int _dragonBones_DragonBones___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "db.DragonBones");
...
static int _dragonBones_DragonBones_advanceTime(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.DragonBones");
...
static int _dragonBones_DragonBones_bufferEvent(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.DragonBones");
    olua_check_obj(L, 2, &arg1, "db.EventObject");
...
static int _dragonBones_DragonBones_bufferObject(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.DragonBones");
    olua_check_obj(L, 2, &arg1, "db.BaseObject");
...
static int _dragonBones_DragonBones_getClock(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.WorldClock");
...
static int _dragonBones_DragonBones_getEventManager(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.IEventDispatcher");
...
{
    oluacls_class(L, "db.DragonBones", nullptr);
    ...
    oluacls_const_string(L, "VEISION", (const char *)dragonBones::DragonBones::VEISION.c_str());

    olua_registerluatype<dragonBones::DragonBones>(L, "db.DragonBones");
...
static int _dragonBones_BaseObject___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "db.BaseObject");
...
static int _dragonBones_BaseObject_getClassTypeIndex(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.BaseObject");
...
static int _dragonBones_EventObject___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::EventObject *)olua_toobj(L, 1, "db.EventObject");
    olua_push_obj(L, self, "db.EventObject");
...
static int _dragonBones_EventObject_actionDataToInstance(lua_State *L)
{
    ...
    olua_check_obj(L, 1, &arg1, "db.ActionData");
    olua_check_obj(L, 2, &arg2, "db.EventObject");
    olua_check_obj(L, 3, &arg3, "db.Armature");
...
static int _dragonBones_EventObject_getArmature(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.Armature");
...
static int _dragonBones_EventObject_getBone(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.Bone");
...
static int _dragonBones_EventObject_getData(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.UserData");
...
static int _dragonBones_EventObject_getSlot(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.Slot");
...
static int _dragonBones_EventObject_new(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.EventObject");
    olua_postnew(L, ret);
...
static int _dragonBones_EventObject_get_actionData(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.ActionData");
...
static int _dragonBones_EventObject_set_actionData(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.EventObject");
    olua_check_obj(L, 2, &arg1, "db.ActionData");
...
static int _dragonBones_EventObject_set_animationState(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.EventObject");
    olua_check_obj(L, 2, &arg1, "db.AnimationState");
...
static int _dragonBones_EventObject_set_armature(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.EventObject");
    olua_check_obj(L, 2, &arg1, "db.Armature");
...
static int _dragonBones_EventObject_set_bone(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.EventObject");
    olua_check_obj(L, 2, &arg1, "db.Bone");
...
static int _dragonBones_EventObject_set_data(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.EventObject");
    olua_check_obj(L, 2, &arg1, "db.UserData");
...
static int _dragonBones_EventObject_set_slot(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.EventObject");
    olua_check_obj(L, 2, &arg1, "db.Slot");
...
OLUA_LIB int luaopen_dragonBones_EventObject(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_EventObject___olua_move);
...
static int _dragonBones_TransformObject___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::TransformObject *)olua_toobj(L, 1, "db.TransformObject");
    olua_push_obj(L, self, "db.TransformObject");
...
static int _dragonBones_TransformObject_getArmature(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.TransformObject");
...
OLUA_LIB int luaopen_dragonBones_TransformObject(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_TransformObject___olua_move);
...
static int _dragonBones_Point_getHelpPointA(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.Point");
...
static int _dragonBones_ConstraintData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::ConstraintData *)olua_toobj(L, 1, "db.ConstraintData");
    olua_push_obj(L, self, "db.ConstraintData");
...
static int _dragonBones_ConstraintData_getBone(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.ConstraintData");

    // const dragonBones::BoneData *getBone()
    const dragonBones::BoneData *ret = self->getBone();
    int num_ret = olua_push_obj(L, ret, "db.BoneData");
...
static int _dragonBones_ConstraintData_setBone(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.ConstraintData");
    olua_check_obj(L, 2, &arg1, "db.BoneData");
...
OLUA_LIB int luaopen_dragonBones_ConstraintData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_ConstraintData___olua_move);
...
static int _dragonBones_IKConstraintData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::IKConstraintData *)olua_toobj(L, 1, "db.IKConstraintData");
    olua_push_obj(L, self, "db.IKConstraintData");
...
static int _dragonBones_IKConstraintData_new(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.IKConstraintData");
    olua_postnew(L, ret);
...
static int _dragonBones_IKConstraintData_get_bendPositive(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.IKConstraintData");
...
OLUA_LIB int luaopen_dragonBones_IKConstraintData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_IKConstraintData___olua_move);
...
static int _dragonBones_TimelineData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::TimelineData *)olua_toobj(L, 1, "db.TimelineData");
    olua_push_obj(L, self, "db.TimelineData");
...
static int _dragonBones_TimelineData_getType(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.TimelineData");
...
static int _dragonBones_TimelineData_new(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.TimelineData");
    olua_postnew(L, ret);
...
OLUA_LIB int luaopen_dragonBones_TimelineData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_TimelineData___olua_move);
...
static int _dragonBones_IAnimatable___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "db.IAnimatable");
...
static int _dragonBones_IAnimatable_advanceTime(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.IAnimatable");
    olua_check_number(L, 2, &arg1);
...
static int _dragonBones_IAnimatable_setClock(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.IAnimatable");
    olua_check_obj(L, 2, &arg1, "db.WorldClock");
...
static int _dragonBones_WorldClock___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::WorldClock *)olua_toobj(L, 1, "db.WorldClock");
    olua_push_obj(L, self, "db.WorldClock");
...
static int _dragonBones_WorldClock_add(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.WorldClock");
    olua_check_obj(L, 2, &arg1, "db.IAnimatable");
...
OLUA_LIB int luaopen_dragonBones_WorldClock(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_WorldClock___olua_move);
...
static int _dragonBones_Slot___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::Slot *)olua_toobj(L, 1, "db.Slot");
    olua_push_obj(L, self, "db.Slot");
...
static int _dragonBones_Slot_getBoundingBoxData(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.BoundingBoxData");
...
static int _dragonBones_Slot_getSlotData(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.SlotData");
...
static int _dragonBones_Slot_init(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.Slot");
    olua_check_obj(L, 2, &arg1, "db.SlotData");
    olua_check_obj(L, 3, &arg2, "db.Armature");
    olua_check_obj(L, 4, &arg3, "void *");
...
static int _dragonBones_Slot_intersectsSegment$1(lua_State *L)
{
    ...
    olua_check_obj(L, 6, &arg5, "db.Point");
    olua_check_obj(L, 7, &arg6, "db.Point");
    olua_check_obj(L, 8, &arg7, "db.Point");
...
static int _dragonBones_Slot_replaceDisplayData(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.Slot");
    olua_check_obj(L, 2, &arg1, "db.DisplayData");
...
OLUA_LIB int luaopen_dragonBones_Slot(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_Slot___olua_move);
...
static int _dragonBones_Bone___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::Bone *)olua_toobj(L, 1, "db.Bone");
    olua_push_obj(L, self, "db.Bone");
...
OLUA_LIB int luaopen_dragonBones_Bone(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_Bone___olua_move);
...
static int _dragonBones_DisplayData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::DisplayData *)olua_toobj(L, 1, "db.DisplayData");
    olua_push_obj(L, self, "db.DisplayData");
...
static int _dragonBones_DisplayData_getParent(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.DisplayData");

    // dragonBones::SkinData *getParent()
    dragonBones::SkinData *ret = self->getParent();
    int num_ret = olua_push_obj(L, ret, "db.SkinData");
...
static int _dragonBones_DisplayData_setParent(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.DisplayData");
    olua_check_obj(L, 2, &arg1, "db.SkinData");
...
OLUA_LIB int luaopen_dragonBones_DisplayData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_DisplayData___olua_move);
...
static int _dragonBones_ActionData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::ActionData *)olua_toobj(L, 1, "db.ActionData");
    olua_push_obj(L, self, "db.ActionData");
...
static int _dragonBones_ActionData_getBone(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.ActionData");
...
OLUA_LIB int luaopen_dragonBones_ActionData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_ActionData___olua_move);
...
static int _dragonBones_UserData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::UserData *)olua_toobj(L, 1, "db.UserData");
    olua_push_obj(L, self, "db.UserData");
...
static int _dragonBones_UserData_addFloat(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.UserData");
    olua_check_number(L, 2, &arg1);
...
static int _dragonBones_UserData_getInts(lua_State *L)
{
    ...
    int num_ret = olua_push_array<int>(L, &ret, [L](int &value) {
...
OLUA_LIB int luaopen_dragonBones_UserData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_UserData___olua_move);
...
static int _dragonBones_BoundingBoxData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::BoundingBoxData *)olua_toobj(L, 1, "db.BoundingBoxData");
    olua_push_obj(L, self, "db.BoundingBoxData");
...
static int _dragonBones_BoundingBoxData_containsPoint(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.BoundingBoxData");
    olua_check_number(L, 2, &arg1);
    olua_check_number(L, 3, &arg2);
...
OLUA_LIB int luaopen_dragonBones_BoundingBoxData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_BoundingBoxData___olua_move);
...
static int _dragonBones_BoundingBoxDisplayData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::BoundingBoxDisplayData *)olua_toobj(L, 1, "db.BoundingBoxDisplayData");
    olua_push_obj(L, self, "db.BoundingBoxDisplayData");
...
static int _dragonBones_BoundingBoxDisplayData_getBoundingBox(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.BoundingBoxDisplayData");
...
static int _dragonBones_BoundingBoxDisplayData_new(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.BoundingBoxDisplayData");
    olua_postnew(L, ret);
...
static int _dragonBones_BoundingBoxDisplayData_setBoundingBox(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.BoundingBoxDisplayData");
    olua_check_obj(L, 2, &arg1, "db.BoundingBoxData");
...
OLUA_LIB int luaopen_dragonBones_BoundingBoxDisplayData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_BoundingBoxDisplayData___olua_move);
...
static int _dragonBones_CanvasData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::CanvasData *)olua_toobj(L, 1, "db.CanvasData");
    olua_push_obj(L, self, "db.CanvasData");
...
static int _dragonBones_CanvasData_new(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.CanvasData");
    olua_postnew(L, ret);
...
static int _dragonBones_CanvasData_get_aabb(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.CanvasData");

    // dragonBones::Rectangle aabb
    dragonBones::Rectangle ret = self->aabb;
    int num_ret = olua_push_dragonBones_Rectangle(L, &ret);
...
static int _dragonBones_CanvasData_set_aabb(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.CanvasData");
    olua_check_dragonBones_Rectangle(L, 2, &arg1);
...
OLUA_LIB int luaopen_dragonBones_CanvasData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_CanvasData___olua_move);
...
static int _dragonBones_TextureAtlasData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::TextureAtlasData *)olua_toobj(L, 1, "db.TextureAtlasData");
    olua_push_obj(L, self, "db.TextureAtlasData");
...
static int _dragonBones_TextureAtlasData_addTexture(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.TextureAtlasData");
    olua_check_obj(L, 2, &arg1, "db.TextureData");
...
static int _dragonBones_TextureAtlasData_createTexture(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.TextureData");
...
static int _dragonBones_TextureAtlasData_getTextures(lua_State *L)
{
    ...
    int num_ret = olua_push_map<std::string, dragonBones::TextureData *>(L, &ret, [L](std::string &arg1, dragonBones::TextureData *arg2) {
        ...
        olua_push_obj(L, arg2, "db.TextureData");
    });
...
static int _dragonBones_TextureAtlasData_set_textures(lua_State *L)
{
    ...
    olua_check_map<std::string, dragonBones::TextureData *>(L, 2, &arg1, [L](std::string *arg1, dragonBones::TextureData **arg2) {
        ...
        olua_check_obj(L, -2, arg2, "db.TextureData");
    });
...
OLUA_LIB int luaopen_dragonBones_TextureAtlasData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_TextureAtlasData___olua_move);
...
static int _dragonBones_TextureData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::TextureData *)olua_toobj(L, 1, "db.TextureData");
    olua_push_obj(L, self, "db.TextureData");
...
static int _dragonBones_TextureData_setParent(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.TextureData");
    olua_check_obj(L, 2, &arg1, "db.TextureAtlasData");
...
OLUA_LIB int luaopen_dragonBones_TextureData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_TextureData___olua_move);
...
static int _dragonBones_ArmatureData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::ArmatureData *)olua_toobj(L, 1, "db.ArmatureData");
    olua_push_obj(L, self, "db.ArmatureData");
...
static int _dragonBones_ArmatureData_addAction(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.ArmatureData");
    olua_check_obj(L, 2, &arg1, "db.ActionData");
...
static int _dragonBones_ArmatureData_addAnimation(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.ArmatureData");
    olua_check_obj(L, 2, &arg1, "db.AnimationData");
...
static int _dragonBones_ArmatureData_addConstraint(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.ArmatureData");
    olua_check_obj(L, 2, &arg1, "db.ConstraintData");
...
static int _dragonBones_ArmatureData_getActions(lua_State *L)
{
    ...
    int num_ret = olua_push_array<dragonBones::ActionData *>(L, &ret, [L](dragonBones::ActionData *value) {
        olua_push_obj(L, value, "db.ActionData");
    });
...
static int _dragonBones_ArmatureData_getAnimation(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.AnimationData");
...
static int _dragonBones_ArmatureData_getConstraint(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.ConstraintData");
...
static int _dragonBones_ArmatureData_getParent(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.DragonBonesData");
...
static int _dragonBones_ArmatureData_getSortedBones(lua_State *L)
{
    ...
    int num_ret = olua_push_array<dragonBones::BoneData *>(L, &ret, [L](dragonBones::BoneData *value) {
        olua_push_obj(L, value, "db.BoneData");
    });
...
static int _dragonBones_ArmatureData_getSortedSlots(lua_State *L)
{
    ...
    int num_ret = olua_push_array<dragonBones::SlotData *>(L, &ret, [L](dragonBones::SlotData *value) {
        olua_push_obj(L, value, "db.SlotData");
    });
...
static int _dragonBones_ArmatureData_new(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.ArmatureData");
    olua_postnew(L, ret);
...
static int _dragonBones_ArmatureData_setParent(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.ArmatureData");
    olua_check_obj(L, 2, &arg1, "db.DragonBonesData");
...
static int _dragonBones_ArmatureData_set_actions(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.ArmatureData");
    olua_check_array<dragonBones::ActionData *>(L, 2, &arg1, [L](dragonBones::ActionData **value) {
        olua_check_obj(L, -1, value, "db.ActionData");
    });
...
static int _dragonBones_ArmatureData_get_animations(lua_State *L)
{
    ...
    int num_ret = olua_push_map<std::string, dragonBones::AnimationData *>(L, &ret, [L](std::string &arg1, dragonBones::AnimationData *arg2) {
        olua_push_std_string(L, (std::string)arg1);
        olua_push_obj(L, arg2, "db.AnimationData");
    });
...
static int _dragonBones_ArmatureData_set_animations(lua_State *L)
{
    ...
    olua_check_map<std::string, dragonBones::AnimationData *>(L, 2, &arg1, [L](std::string *arg1, dragonBones::AnimationData **arg2) {
        olua_check_std_string(L, -1, arg1);
        olua_check_obj(L, -2, arg2, "db.AnimationData");
    });
...
static int _dragonBones_ArmatureData_get_bones(lua_State *L)
{
    ...
    int num_ret = olua_push_map<std::string, dragonBones::BoneData *>(L, &ret, [L](std::string &arg1, dragonBones::BoneData *arg2) {
        olua_push_std_string(L, (std::string)arg1);
        olua_push_obj(L, arg2, "db.BoneData");
    });
...
static int _dragonBones_ArmatureData_set_bones(lua_State *L)
{
    ...
    olua_check_map<std::string, dragonBones::BoneData *>(L, 2, &arg1, [L](std::string *arg1, dragonBones::BoneData **arg2) {
        olua_check_std_string(L, -1, arg1);
        olua_check_obj(L, -2, arg2, "db.BoneData");
    });
...
static int _dragonBones_ArmatureData_set_canvas(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.ArmatureData");
    olua_check_obj(L, 2, &arg1, "db.CanvasData");
...
static int _dragonBones_ArmatureData_get_constraints(lua_State *L)
{
    ...
    int num_ret = olua_push_map<std::string, dragonBones::ConstraintData *>(L, &ret, [L](std::string &arg1, dragonBones::ConstraintData *arg2) {
        olua_push_std_string(L, (std::string)arg1);
        olua_push_obj(L, arg2, "db.ConstraintData");
    });
...
static int _dragonBones_ArmatureData_set_constraints(lua_State *L)
{
    ...
    olua_check_map<std::string, dragonBones::ConstraintData *>(L, 2, &arg1, [L](std::string *arg1, dragonBones::ConstraintData **arg2) {
        olua_check_std_string(L, -1, arg1);
        olua_check_obj(L, -2, arg2, "db.ConstraintData");
    });
...
static int _dragonBones_ArmatureData_get_skins(lua_State *L)
{
    ...
    int num_ret = olua_push_map<std::string, dragonBones::SkinData *>(L, &ret, [L](std::string &arg1, dragonBones::SkinData *arg2) {
        olua_push_std_string(L, (std::string)arg1);
        olua_push_obj(L, arg2, "db.SkinData");
    });
...
static int _dragonBones_ArmatureData_set_skins(lua_State *L)
{
    ...
    olua_check_map<std::string, dragonBones::SkinData *>(L, 2, &arg1, [L](std::string *arg1, dragonBones::SkinData **arg2) {
        olua_check_std_string(L, -1, arg1);
        olua_check_obj(L, -2, arg2, "db.SkinData");
    });
...
static int _dragonBones_ArmatureData_get_slots(lua_State *L)
{
    ...
    int num_ret = olua_push_map<std::string, dragonBones::SlotData *>(L, &ret, [L](std::string &arg1, dragonBones::SlotData *arg2) {
        olua_push_std_string(L, (std::string)arg1);
        olua_push_obj(L, arg2, "db.SlotData");
    });
...
static int _dragonBones_ArmatureData_set_slots(lua_State *L)
{
    ...
    olua_check_map<std::string, dragonBones::SlotData *>(L, 2, &arg1, [L](std::string *arg1, dragonBones::SlotData **arg2) {
        olua_check_std_string(L, -1, arg1);
        olua_check_obj(L, -2, arg2, "db.SlotData");
    });
...
static int _dragonBones_ArmatureData_set_sortedBones(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.ArmatureData");
    olua_check_array<dragonBones::BoneData *>(L, 2, &arg1, [L](dragonBones::BoneData **value) {
        olua_check_obj(L, -1, value, "db.BoneData");
    });
...
static int _dragonBones_ArmatureData_set_sortedSlots(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.ArmatureData");
    olua_check_array<dragonBones::SlotData *>(L, 2, &arg1, [L](dragonBones::SlotData **value) {
        olua_check_obj(L, -1, value, "db.SlotData");
    });
...
OLUA_LIB int luaopen_dragonBones_ArmatureData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_ArmatureData___olua_move);
...
static int _dragonBones_SkinData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::SkinData *)olua_toobj(L, 1, "db.SkinData");
    olua_push_obj(L, self, "db.SkinData");
...
static int _dragonBones_SkinData_addDisplay(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.SkinData");
    olua_check_std_string(L, 2, &arg1);
    olua_check_obj(L, 3, &arg2, "db.DisplayData");
...
static int _dragonBones_SkinData_getDisplay(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.DisplayData");
...
static int _dragonBones_SkinData_set_parent(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.SkinData");
    olua_check_obj(L, 2, &arg1, "db.ArmatureData");
...
OLUA_LIB int luaopen_dragonBones_SkinData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_SkinData___olua_move);
...
static int _dragonBones_BoneData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::BoneData *)olua_toobj(L, 1, "db.BoneData");
    olua_push_obj(L, self, "db.BoneData");
...
static int _dragonBones_BoneData_getParent(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.BoneData");
...
OLUA_LIB int luaopen_dragonBones_BoneData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_BoneData___olua_move);
...
static int _dragonBones_SlotData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::SlotData *)olua_toobj(L, 1, "db.SlotData");
    olua_push_obj(L, self, "db.SlotData");
...
static int _dragonBones_SlotData_getBlendMode(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.SlotData");
...
OLUA_LIB int luaopen_dragonBones_SlotData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_SlotData___olua_move);
...
static int _dragonBones_AnimationState___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::AnimationState *)olua_toobj(L, 1, "db.AnimationState");
    olua_push_obj(L, self, "db.AnimationState");
...
static int _dragonBones_AnimationState_addBoneMask$1(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.AnimationState");
    olua_check_std_string(L, 2, &arg1);
    olua_check_bool(L, 3, &arg2);
...
static int _dragonBones_AnimationState_init(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.AnimationState");
    olua_check_obj(L, 2, &arg1, "db.Armature");
    olua_check_obj(L, 3, &arg2, "db.AnimationData");
    olua_check_obj(L, 4, &arg3, "db.AnimationConfig");
...
OLUA_LIB int luaopen_dragonBones_AnimationState(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_AnimationState___olua_move);
...
static int _dragonBones_AnimationData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::AnimationData *)olua_toobj(L, 1, "db.AnimationData");
    olua_push_obj(L, self, "db.AnimationData");
...
static int _dragonBones_AnimationData_addBoneTimeline(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.AnimationData");
    olua_check_obj(L, 2, &arg1, "db.BoneData");
    olua_check_obj(L, 3, &arg2, "db.TimelineData");
...
static int _dragonBones_AnimationData_setActionTimeline(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.AnimationData");
    olua_check_obj(L, 2, &arg1, "db.TimelineData");
...
OLUA_LIB int luaopen_dragonBones_AnimationData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_AnimationData___olua_move);
...
static int _dragonBones_AnimationConfig___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::AnimationConfig *)olua_toobj(L, 1, "db.AnimationConfig");
    olua_push_obj(L, self, "db.AnimationConfig");
...
static int _dragonBones_AnimationConfig_addBoneMask(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.AnimationConfig");
    olua_check_obj(L, 2, &arg1, "db.Armature");
    olua_check_std_string(L, 3, &arg2);
...
static int _dragonBones_AnimationConfig_copyFrom(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.AnimationConfig");
    olua_check_obj(L, 2, &arg1, "db.AnimationConfig");
...
static int _dragonBones_AnimationConfig_new(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.AnimationConfig");
    olua_postnew(L, ret);
...
OLUA_LIB int luaopen_dragonBones_AnimationConfig(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_AnimationConfig___olua_move);
...
static int _dragonBones_DragonBonesData___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::DragonBonesData *)olua_toobj(L, 1, "db.DragonBonesData");
    olua_push_obj(L, self, "db.DragonBonesData");
...
static int _dragonBones_DragonBonesData_addArmature(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.DragonBonesData");
    olua_check_obj(L, 2, &arg1, "db.ArmatureData");
...
static int _dragonBones_DragonBonesData_get_armatures(lua_State *L)
{
    ...
    int num_ret = olua_push_map<std::string, dragonBones::ArmatureData *>(L, &ret, [L](std::string &arg1, dragonBones::ArmatureData *arg2) {
        olua_push_std_string(L, (std::string)arg1);
        olua_push_obj(L, arg2, "db.ArmatureData");
    });
...
static int _dragonBones_DragonBonesData_set_armatures(lua_State *L)
{
    ...
    olua_check_map<std::string, dragonBones::ArmatureData *>(L, 2, &arg1, [L](std::string *arg1, dragonBones::ArmatureData **arg2) {
        olua_check_std_string(L, -1, arg1);
        olua_check_obj(L, -2, arg2, "db.ArmatureData");
    });
...
static int _dragonBones_DragonBonesData_get_frameIndices(lua_State *L)
{
    ...
    int num_ret = olua_push_array<unsigned int>(L, &ret, [L](unsigned int &value) {
...
static int _dragonBones_DragonBonesData_set_frameIndices(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.DragonBonesData");
    olua_check_array<unsigned int>(L, 2, &arg1, [L](unsigned int *value) {
        lua_Unsigned obj;
        olua_check_uint(L, -1, &obj);
        *value = (unsigned int)obj;
    });
...
OLUA_LIB int luaopen_dragonBones_DragonBonesData(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_DragonBonesData___olua_move);
...
static int _dragonBones_BaseFactory___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "db.BaseFactory");
...
static int _dragonBones_BaseFactory_addDragonBonesData$1(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.BaseFactory");
    olua_check_obj(L, 2, &arg1, "db.DragonBonesData");
    olua_check_std_string(L, 3, &arg2);
...
static int _dragonBones_BaseFactory_getAllDragonBonesData(lua_State *L)
{
    ...
    int num_ret = olua_push_map<std::string, dragonBones::DragonBonesData *>(L, &ret, [L](std::string &arg1, dragonBones::DragonBonesData *arg2) {
        olua_push_std_string(L, (std::string)arg1);
        olua_push_obj(L, arg2, "db.DragonBonesData");
    });
...
static int _dragonBones_BaseFactory_replaceAnimation$1(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.BaseFactory");
    olua_check_obj(L, 2, &arg1, "db.Armature");
    olua_check_obj(L, 3, &arg2, "db.ArmatureData");
    olua_check_bool(L, 4, &arg3);
...
static int _dragonBones_BaseFactory_replaceSlotDisplay$1(lua_State *L)
{
    ...
    olua_check_std_string(L, 4, &arg3);
    olua_check_std_string(L, 5, &arg4);
    olua_check_obj(L, 6, &arg5, "db.Slot");
...
static int _dragonBones_BaseFactory_replaceSlotDisplayList(lua_State *L)
{
    ...
    olua_check_std_string(L, 3, &arg2);
    olua_check_std_string(L, 4, &arg3);
    olua_check_obj(L, 5, &arg4, "db.Slot");
...
static int _dragonBones_Armature___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::Armature *)olua_toobj(L, 1, "db.Armature");
    olua_push_obj(L, self, "db.Armature");
...
static int _dragonBones_Armature_advanceTime(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.Armature");
    olua_check_number(L, 2, &arg1);
...
static int _dragonBones_Armature_getAnimatable(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.IAnimatable");
...
static int _dragonBones_Armature_getAnimation(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.Animation");
...
static int _dragonBones_Armature_getBones(lua_State *L)
{
    ...
    int num_ret = olua_push_array<dragonBones::Bone *>(L, &ret, [L](dragonBones::Bone *value) {
        olua_push_obj(L, value, "db.Bone");
    });
...
static int _dragonBones_Armature_getProxy(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.IArmatureProxy");
...
static int _dragonBones_Armature_getSlots(lua_State *L)
{
    ...
    int num_ret = olua_push_array<dragonBones::Slot *>(L, &ret, [L](dragonBones::Slot *value) {
        olua_push_obj(L, value, "db.Slot");
    });
...
static int _dragonBones_Armature_init(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.Armature");
    olua_check_obj(L, 2, &arg1, "db.ArmatureData");
    olua_check_obj(L, 3, &arg2, "db.IArmatureProxy");
    olua_check_obj(L, 4, &arg3, "void *");
    olua_check_obj(L, 5, &arg4, "db.DragonBones");
...
static int _dragonBones_Animation___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::Animation *)olua_toobj(L, 1, "db.Animation");
    olua_push_obj(L, self, "db.Animation");
...
static int _dragonBones_Animation_advanceTime(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.Animation");
    olua_check_number(L, 2, &arg1);
...
static int _dragonBones_Animation_getStates(lua_State *L)
{
    ...
    int num_ret = olua_push_array<dragonBones::AnimationState *>(L, &ret, [L](dragonBones::AnimationState *value) {
        olua_push_obj(L, value, "db.AnimationState");
    });
...
OLUA_LIB int luaopen_dragonBones_Animation(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_Animation___olua_move);
...
static int _dragonBones_CCFactory___olua_move(lua_State *L)
{
    olua_startinvoke(L);

    auto self = (dragonBones::CCFactory *)olua_toobj(L, 1, "db.Factory");
    olua_push_obj(L, self, "db.Factory");
...
static int _dragonBones_CCFactory_buildArmatureDisplay$1(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.Factory");
    olua_check_std_string(L, 2, &arg1);
    olua_check_std_string(L, 3, &arg2);
    olua_check_std_string(L, 4, &arg3);
    olua_check_std_string(L, 5, &arg4);
    ...
    int num_ret = olua_push_obj(L, ret, "db.ArmatureDisplay");
...
static int _dragonBones_CCFactory_getFactory(lua_State *L)
{
    ...
    int num_ret = olua_push_obj(L, ret, "db.Factory");
...
OLUA_LIB int luaopen_dragonBones_CCFactory(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_CCFactory___olua_move);
...
static int _dragonBones_IEventDispatcher___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "db.IEventDispatcher");
...
static int _dragonBones_IEventDispatcher_addDBEventListener(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.IEventDispatcher");
    olua_check_std_string(L, 2, &arg1);
    ...
    arg2 = [cb_store, cb_name, cb_ctx](dragonBones::EventObject *arg1) {
        ...
        if (olua_contextequal(L, cb_ctx)) {
            ...
            olua_push_obj(L, arg1, "db.EventObject");
...
static int _dragonBones_IEventDispatcher_dispatchDBEvent(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.IEventDispatcher");
    olua_check_std_string(L, 2, &arg1);
    olua_check_obj(L, 3, &arg2, "db.EventObject");
...
static int _dragonBones_IArmatureProxy___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "db.IArmatureProxy");
...
static int _dragonBones_IArmatureProxy_dbClear(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.IArmatureProxy");
...
static int _dragonBones_CCArmatureDisplay___olua_move(lua_State *L)
{
    ...
    olua_push_obj(L, self, "db.ArmatureDisplay");
...
static int _dragonBones_CCArmatureDisplay_addDBEventListener(lua_State *L)
{
    ...
    olua_to_obj(L, 1, &self, "db.ArmatureDisplay");
    olua_check_std_string(L, 2, &arg1);
    olua_check_callback(L, 3, &arg2, "std.function");
...
OLUA_LIB int luaopen_dragonBones_CCArmatureDisplay(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _dragonBones_CCArmatureDisplay___olua_move);
