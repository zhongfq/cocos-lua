...
static int _fairygui_UIEventDispatcher_addEventListener1(lua_State *L)
{
    ...
    arg2 = [callback_store_obj, func, context](fairygui::EventContext *arg1) {
...
static int _fairygui_InputProcessor_setCaptureCallback(lua_State *L)
{
    ...
    if (olua_is_std_function(L, 2)) {
        ...
        lua_Unsigned context = olua_context(L);
        arg1 = [callback_store_obj, func, context](int arg1) {
            lua_State *L = olua_mainthread();
...
static int _fairygui_GTweener_onComplete1(lua_State *L)
{
    ...
    std::string func = olua_setcallback(L, callback_store_obj, tag.c_str(), 2, OLUA_TAG_REPLACE);
    lua_Unsigned context = olua_context(L);
    arg1 = [callback_store_obj, func, context](fairygui::GTweener *arg1) {
        lua_State *L = olua_mainthread();
...
static int _fairygui_GObject_addClickListener1(lua_State *L)
{
    ...
    lua_Unsigned context = olua_context(L);
    arg1 = [callback_store_obj, func, context](fairygui::EventContext *arg1) {
        lua_State *L = olua_mainthread();
...
static int _fairygui_GList_set_itemRenderer(lua_State *L)
{
    ...
    std::string func = olua_setcallback(L, callback_store_obj, tag.c_str(), 2, OLUA_TAG_REPLACE);
    lua_Unsigned context = olua_context(L);
    arg1 = [callback_store_obj, func, context](int arg1, fairygui::GObject *arg2) {
        lua_State *L = olua_mainthread();
...
static int _fairygui_GMovieClip_setPlaySettings1(lua_State *L)
{
    ...
    if (olua_is_std_function(L, 6)) {
        ...
        lua_Unsigned context = olua_context(L);
        arg5 = [callback_store_obj, func, context]() {
            lua_State *L = olua_mainthread();
...
static int _fairygui_PopupMenu_addItemAt(lua_State *L)
{
    ...
    lua_Unsigned context = olua_context(L);
    arg3 = [callback_store_obj, func, context](fairygui::EventContext *arg1) {
        lua_State *L = olua_mainthread();
...
static int _fairygui_GTree_set_treeNodeRender(lua_State *L)
{
    ...
    if (olua_is_std_function(L, 2)) {
        ...
        std::string func = olua_setcallback(L, callback_store_obj, tag.c_str(), 2, OLUA_TAG_REPLACE);
        lua_Unsigned context = olua_context(L);
        arg1 = [callback_store_obj, func, context](fairygui::GTreeNode *arg1, fairygui::GComponent *arg2) {
            lua_State *L = olua_mainthread();
...
static int _fairygui_GTree_set_treeNodeWillExpand(lua_State *L)
{
    ...
    if (olua_is_std_function(L, 2)) {
        ...
        std::string func = olua_setcallback(L, callback_store_obj, tag.c_str(), 2, OLUA_TAG_REPLACE);
        lua_Unsigned context = olua_context(L);
        arg1 = [callback_store_obj, func, context](fairygui::GTreeNode *arg1, bool arg2) {
            lua_State *L = olua_mainthread();
