...
function main()
    ...
    timer.delay(4, function ()
        ...
        printUserValue(director, "pushScene")
        director:pushScene(s3)
        printUserValue(director, "pushScene")
        director:pushScene(s4)
        printUserValue(director, "pushScene")
        director:replaceScene(s5)
        printUserValue(director, "replaceScnee")
        director:popScene()
        printUserValue(director, "propScene")
        director:popToSceneStackLevel(2)
        printUserValue(director, "propSceneTolee 2")
        director:popToRootScene()
        printUserValue(director, "propSceneToROot")
    end)
end
