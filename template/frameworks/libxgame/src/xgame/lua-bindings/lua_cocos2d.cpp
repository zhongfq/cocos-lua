...
static int _cocos2d_Scheduler_schedule(lua_State *L)
{
    ...
    if (num_args == 5) {
        // if (olua_is_std_function(L, 2) && xluacv_is_obj(L, 3) && olua_is_number(L, 4) && olua_is_bool(L, 5) && olua_is_std_string(L, 6)) {
            return _cocos2d_Scheduler_schedule1(L);
        // }
    }

    if (num_args == 7) {
        // if (olua_is_std_function(L, 2) && xluacv_is_obj(L, 3) && olua_is_number(L, 4) && olua_is_uint(L, 5) && olua_is_number(L, 6) && olua_is_bool(L, 7) && olua_is_std_string(L, 8)) {
...
static int _cocos2d_TextureCache_addImage(lua_State *L)
{
    ...
    if (num_args == 2) {
        // if (xluacv_is_ccobj(L, 2, "cc.Image") && olua_is_std_string(L, 3)) {
...
static int _cocos2d_Texture2D_initWithImage(lua_State *L)
{
    ...
    if (num_args == 2) {
        // if (xluacv_is_ccobj(L, 2, "cc.Image") && olua_is_uint(L, 3)) {
...
static int _cocos2d_Node_addChild(lua_State *L)
{
    ...
    if (num_args == 2) {
        // if (xluacv_is_ccobj(L, 2, "cc.Node") && olua_is_int(L, 3)) {
            return _cocos2d_Node_addChild2(L);
        // }
    }

    if (num_args == 3) {
        if (xluacv_is_ccobj(L, 2, "cc.Node") && olua_is_int(L, 3) && olua_is_int(L, 4)) {
            return _cocos2d_Node_addChild3(L);
        }

        // if (xluacv_is_ccobj(L, 2, "cc.Node") && olua_is_int(L, 3) && olua_is_std_string(L, 4)) {
