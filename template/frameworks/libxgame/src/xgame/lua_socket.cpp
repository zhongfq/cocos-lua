...
LUALIB_API int luaopen_socket(lua_State *L)
{
    ...
    oluacls_setfunc(L, "__gc", _socket_gc);
    oluacls_setfunc(L, "new", _socket_new);
    oluacls_setfunc(L, "connect", _socket_connect);
    oluacls_setfunc(L, "close", _socket_close);
    oluacls_setfunc(L, "clear", _scoket_clear);
    oluacls_setfunc(L, "flush", _socket_flush);
    oluacls_setfunc(L, "readUbyte", _socket_read_ubyte);
    oluacls_setfunc(L, "writeUbyte", _socket_write_ubyte);
    oluacls_setfunc(L, "readUshort", _socket_read_ushort);
    oluacls_setfunc(L, "writeUshort", _socket_write_ushort);
    oluacls_setfunc(L, "readUint", _socket_read_uint);
    oluacls_setfunc(L, "writeUint", _socket_write_uint);
    oluacls_setfunc(L, "readUint64", _socket_read_uint64);
    oluacls_setfunc(L, "writeUint64", _socket_write_uint64);
    oluacls_setfunc(L, "readByte", _socket_read_byte);
    oluacls_setfunc(L, "writeByte", _socket_write_byte);
    oluacls_setfunc(L, "readShort", _socket_read_short);
    oluacls_setfunc(L, "writeShort", _socket_write_short);
    oluacls_setfunc(L, "readInt", _socket_read_int);
    oluacls_setfunc(L, "writeInt", _socket_write_int);
    oluacls_setfunc(L, "readInt64", _socket_read_int64);
    oluacls_setfunc(L, "writeInt64", _socket_write_int64);
    oluacls_setfunc(L, "readFloat", _socket_read_float);
    oluacls_setfunc(L, "writeFloat", _socket_write_float);
    oluacls_setfunc(L, "readDouble", _socket_read_double);
    oluacls_setfunc(L, "writeDouble", _socket_write_double);
    oluacls_setfunc(L, "readBytes", _socket_read_bytes);
    oluacls_setfunc(L, "writeBytes", _socket_write_bytes);
    oluacls_property(L, "bytesAvailable", _socket_bytes_available, NULL);
    oluacls_property(L, "status", _socket_get_status, NULL);
