...
typeconf 'cocos2d::Mat4'
    ...
    .func(nil, 'static void createOrthographic(float width, float height, float zNearPlane, float zFarPlane, cocos2d::Mat4 *dst)')
    .func(nil, 'static void createOrthographicOffCenter(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane, cocos2d::Mat4 *dst)')
    .func(nil, 'static void createBillboard(const cocos2d::Vec3 &objectPosition, const cocos2d::Vec3 &cameraPosition, const cocos2d::Vec3 &cameraUpVector, cocos2d::Mat4 *dst)', 'static void createBillboard(const cocos2d::Vec3 &objectPosition, const cocos2d::Vec3 &cameraPosition, const cocos2d::Vec3 &cameraUpVector, const cocos2d::Vec3 &cameraForwardVector, cocos2d::Mat4 *dst)')
    .func(nil, 'static void createScale(const cocos2d::Vec3 &scale, cocos2d::Mat4 *dst)', 'static void createScale(float xScale, float yScale, float zScale, cocos2d::Mat4 *dst)')
    .func(nil, 'static void createRotation(const cocos2d::Quaternion &quat, cocos2d::Mat4 *dst)', 'static void createRotation(const cocos2d::Vec3 &axis, float angle, cocos2d::Mat4 *dst)')
    .func(nil, 'static void createRotationX(float angle, cocos2d::Mat4 *dst)')
    .func(nil, 'static void createRotationY(float angle, cocos2d::Mat4 *dst)')
    .func(nil, 'static void createRotationZ(float angle, cocos2d::Mat4 *dst)')
    .func(nil, 'static void createTranslation(const cocos2d::Vec3 &translation, cocos2d::Mat4 *dst)', 'static void createTranslation(float xTranslation, float yTranslation, float zTranslation, cocos2d::Mat4 *dst)')
    .func(nil, 'void add(float scalar)', 'void add(float scalar, cocos2d::Mat4 *dst)', 'void add(const cocos2d::Mat4 &mat)', 'static void add(const cocos2d::Mat4 &m1, const cocos2d::Mat4 &m2, cocos2d::Mat4 *dst)')
    .func(nil, 'float determinant()')
    .func(nil, 'bool inverse()')
    .func(nil, 'cocos2d::Mat4 getInversed()')
    .func(nil, 'bool isIdentity()')
    .func(nil, 'void multiply(float scalar)', 'void multiply(float scalar, cocos2d::Mat4 *dst)', 'static void multiply(const cocos2d::Mat4 &mat, float scalar, cocos2d::Mat4 *dst)', 'void multiply(const cocos2d::Mat4 &mat)', 'static void multiply(const cocos2d::Mat4 &m1, const cocos2d::Mat4 &m2, cocos2d::Mat4 *dst)')
    .func(nil, 'void negate()')
    .func(nil, 'cocos2d::Mat4 getNegated()')
    .func(nil, 'void rotate(const cocos2d::Quaternion &q)', 'void rotate(const cocos2d::Quaternion &q, cocos2d::Mat4 *dst)', 'void rotate(const cocos2d::Vec3 &axis, float angle)', 'void rotate(const cocos2d::Vec3 &axis, float angle, cocos2d::Mat4 *dst)')
    .func(nil, 'void rotateX(float angle)', 'void rotateX(float angle, cocos2d::Mat4 *dst)')
    .func(nil, 'void rotateY(float angle)', 'void rotateY(float angle, cocos2d::Mat4 *dst)')
    .func(nil, 'void rotateZ(float angle)', 'void rotateZ(float angle, cocos2d::Mat4 *dst)')
    .func(nil, 'void scale(float value)', 'void scale(float value, cocos2d::Mat4 *dst)', 'void scale(float xScale, float yScale, float zScale)', 'void scale(float xScale, float yScale, float zScale, cocos2d::Mat4 *dst)', 'void scale(const cocos2d::Vec3 &s)', 'void scale(const cocos2d::Vec3 &s, cocos2d::Mat4 *dst)')
    .func(nil, 'void set(float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24, float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44)', 'void set(const cocos2d::Mat4 &mat)')
    .func(nil, 'void setIdentity()')
    .func(nil, 'void setZero()')
    .func(nil, 'void subtract(const cocos2d::Mat4 &mat)', 'static void subtract(const cocos2d::Mat4 &m1, const cocos2d::Mat4 &m2, cocos2d::Mat4 *dst)')
    .func(nil, 'void translate(float x, float y, float z)', 'void translate(float x, float y, float z, cocos2d::Mat4 *dst)', 'void translate(const cocos2d::Vec3 &t)', 'void translate(const cocos2d::Vec3 &t, cocos2d::Mat4 *dst)')
    .func(nil, 'void transpose()')
    .func(nil, 'cocos2d::Mat4 getTransposed()')
    .prop('inversed', nil, nil)
    .prop('identity', nil, nil)
    .prop('negated', nil, nil)
    .prop('transposed', nil, nil)
...
typeconf 'cocos2d::Properties'
    ...
    .func(nil, 'bool getMat4(const char *name, cocos2d::Mat4 *out)')
    .func(nil, 'bool getPath(const char *name, @ret std::string *path)')
...
typeconf 'cocos2d::Node'
    ...
    .func(nil, 'void setAdditionalTransform(const cocos2d::Mat4 *additionalTransform)', 'void setAdditionalTransform(const cocos2d::Mat4 &additionalTransform)', 'void setAdditionalTransform(const cocos2d::AffineTransform &additionalTransform)')
...
typeconf 'cocos2d::Scene'
    ...
    .func(nil, 'void render(cocos2d::Renderer *renderer, const cocos2d::Mat4 &eyeTransform, @optional const cocos2d::Mat4 *eyeProjection)')
    .func(nil, 'Scene()')
...
typeconf 'cocos2d::TMXLayer'
    ...
    .func(nil, 'uint32_t getTileGIDAt(const cocos2d::Vec2 &tileCoordinate, @ret cocos2d::TMXTileFlags *flags)')
...
typeconf 'cocos2d::FastTMXLayer'
    ...
    .func(nil, 'int getTileGIDAt(const cocos2d::Vec2 &tileCoordinate, @ret cocos2d::TMXTileFlags *flags)')
