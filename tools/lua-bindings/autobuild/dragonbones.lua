...
cls.func(nil, 'const std::map<std::string, TextureData *> &getTextures()')
...
cls.var('textures', 'std::map<std::string, TextureData *> textures')
cls.prop('textures', nil, nil)
M.CLASSES[#M.CLASSES + 1] = cls
...
cls.var('bones', 'std::map<std::string, BoneData *> bones')
cls.var('slots', 'std::map<std::string, SlotData *> slots')
cls.var('constraints', 'std::map<std::string, ConstraintData *> constraints')
cls.var('skins', 'std::map<std::string, SkinData *> skins')
cls.var('animations', 'std::map<std::string, AnimationData *> animations')
...
cls.var('armatures', 'std::map<std::string, ArmatureData *> armatures')
...
cls.func(nil, 'const std::map<std::string, DragonBonesData *> &getAllDragonBonesData()')
cls.func(nil, 'dragonBones::WorldClock *getClock()')
cls.var('autoSearch', 'bool autoSearch')
cls.prop('allDragonBonesData', nil, nil)
cls.prop('clock', nil, nil)
M.CLASSES[#M.CLASSES + 1] = cls
...
cls.func(nil, 'const std::vector<std::string> &getAnimationNames()')
cls.func(nil, 'const std::map<std::string, AnimationData *> &getAnimations()')
cls.func(nil, 'void setAnimations(const std::map<std::string, AnimationData *> &value)')
