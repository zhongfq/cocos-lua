...
typeconf 'cclua::plugin::oppo'
    ...
    .luaopen(nil)
    .indexerror(nil)
    .ifdef('*', '#ifdef CCLUA_BUILD_OPPO')
    .func(nil, 'static void init()')
    .func(nil, 'static void pay(const std::string &orderNo, const std::string &attach, int price, const std::string &name, const std::string &desc, const std::string &url)')
