...
cls.func(nil, 'void initWithSkeleton(spine::Skeleton *skeleton, @optional bool ownsSkeleton, @optional bool ownsSkeletonData, @optional bool ownsAtlas)')
cls.func(nil, 'void initWithData(spine::SkeletonData *skeletonData, @optional bool ownsSkeletonData)')
cls.func(nil, 'void initWithJsonFile(const std::string &skeletonDataFile, spine::Atlas *atlas, @optional float scale)', 'void initWithJsonFile(const std::string &skeletonDataFile, const std::string &atlasFile, @optional float scale)')
cls.func(nil, 'void initWithBinaryFile(const std::string &skeletonDataFile, spine::Atlas *atlas, @optional float scale)', 'void initWithBinaryFile(const std::string &skeletonDataFile, const std::string &atlasFile, @optional float scale)')
