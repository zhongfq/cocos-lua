...
typeconf 'spine::Animation'
    ...
    .func(nil, 'static int search(Vector<float> &values, float target)', 'static int search(Vector<float> &values, float target, int step)')
    .prop('name', nil, nil)
...
typeconf 'spine::Sequence'
    ...
    .luaopen(nil)
    .indexerror(nil)
    .func(nil, 'Sequence(int count)')
    .func(nil, 'spine::Sequence *copy()')
    .func(nil, 'void apply(spine::Slot *slot, spine::Attachment *attachment)')
    .func(nil, 'spine::String getPath(const spine::String &basePath, int index)')
    .func(nil, 'int getId()')
    .func(nil, 'void setId(int id)')
    .func(nil, 'int getStart()')
    .func(nil, 'void setStart(int start)')
    .func(nil, 'int getDigits()')
    .func(nil, 'void setDigits(int digits)')
    .func(nil, 'int getSetupIndex()')
    .func(nil, 'void setSetupIndex(int setupIndex)')
    .func(nil, 'Vector<spine::TextureRegion *> &getRegions()')
    .prop('id', nil, nil)
    .prop('start', nil, nil)
    .prop('digits', nil, nil)
    .prop('setupIndex', nil, nil)
    .prop('regions', nil, nil)
...
typeconf 'spine::TextureRegion'
    ...
    .luaopen(nil)
    .indexerror(nil)
    .func(nil, 'TextureRegion()')
    .var('rendererObject', 'void *rendererObject')
    .var('u', 'float u')
    .var('v', 'float v')
    .var('u2', 'float u2')
    .var('v2', 'float v2')
    ...
    .var('originalWidth', 'int originalWidth')
    .var('originalHeight', 'int originalHeight')
...
typeconf 'spine::Slot'
    ...
    .func(nil, 'int getSequenceIndex()')
    .func(nil, 'void setSequenceIndex(int index)')
    .prop('color', nil, nil)
    .prop('darkColor', nil, nil)
    .prop('attachment', nil, nil)
    .prop('attachmentState', nil, nil)
    .prop('deform', nil, nil)
    .prop('sequenceIndex', nil, nil)
...
typeconf 'spine::VertexAttachment'
    ...
    .func(nil, 'spine::Attachment *getTimelineAttachment()')
    .func(nil, 'void setTimelineAttachment(spine::Attachment *attachment)')
    .func(nil, 'void copyTo(spine::VertexAttachment *other)')
    .prop('id', nil, nil)
    .prop('bones', nil, nil)
    .prop('vertices', nil, nil)
    .prop('worldVerticesLength', nil, nil)
    .prop('timelineAttachment', nil, nil)
...
typeconf 'spine::MeshAttachment'
    ...
    .func(nil, 'spine::TextureRegion *getRegion()')
    .func(nil, 'void setRegion(spine::TextureRegion *region)')
    .func(nil, 'spine::Sequence *getSequence()')
    .func(nil, 'void setSequence(spine::Sequence *sequence)')
...
typeconf 'spine::TrackEntry'
    ...
    .func(nil, 'bool getShortestRotation()')
    .func(nil, 'void setShortestRotation(bool inValue)')
